...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('sign-up-nav-link')?.addEventListener('click', () => openModal('sign-in-modal')); // Admin requires login
    document.getElementById('mobile-sign-up-nav-link')?.addEventListener('click', () => openModal('sign-in-modal'));
